...
if __name__ == '__main__':
    ...
    #! [e03s01_py]
    # Open file
    testFile = os.getcwd() + '\\Corrector-02-07b4-09_UW01.zmx'
    ...
    npts = 5000
    thetas = numpy.random.uniform(0, 2*numpy.pi, size=npts)
    rs = numpy.random.uniform(0, maxFieldAngle, size=npts)
    xs = numpy.sqrt(rs)*numpy.cos(thetas)
    ys = numpy.sqrt(rs)*numpy.sin(thetas)
    ...
    for ii, (wl, (xField,yField)) in enumerate(combos):
        ...
        Surface14 = TheLDE.GetSurfaceAt(19)
